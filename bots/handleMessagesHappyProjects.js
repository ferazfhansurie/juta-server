...
async function handleNewMessagesHappyProjects(client, msg, botName, phoneIndex) {
...
async function checkingStatus(threadId, runId) {
    ...
    if(status == 'completed') {
        try{
            ...
            console.log("error from handleNewMessagesHappyProjects: "+error)
            throw error;
        }
    }
...
module.exports = { handleNewMessagesHappyProjects };