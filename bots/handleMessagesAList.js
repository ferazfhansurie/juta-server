...
async function addNotificationToUser(companyId, message, contactName) {
    ...
    try {
     ...
     const cleanMessage2 = Object.fromEntries(
        ...
        console.log(`FCM notification sent to topic 92'`);
...
async function processImmediateActions(client, msg, botName, phoneIndex) {
   ...
   console.log('Message stored in Firebase with ID:', messageId);
    try {
        ...
        },
        {
            ...
            function: {
                ...
                parameters: {
                    type: "object",
                    properties: {
                        summary: { type: "string", description: `Title of the event include the word "Phone Tika"` },
