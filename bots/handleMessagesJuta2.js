...
async function handleNewMessagesJuta2(client, msg, botName, phoneIndex) {
    ...
    try {
        ...
        // Wait for a short period to collect any additional messages
        ...
        while (messageQueue.get(chatId).length > 0) {
            ...
            // Process each message individually for Firebase
            ...
            // Process the combined message for AI
