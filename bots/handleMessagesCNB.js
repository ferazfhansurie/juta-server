            ...
            switch (currentStep) {
                case steps.START:
                    ...
                    const carpetTileFilePaths = {
                        ...
                        '**ndnewdelhi**-thepriceper': 'URL_FOR_ND_NEW_DELHI',
                        ...
                        '**starlight**-thepriceper': 'URL_FOR_STARLIGHT',
                        '**landscape**-thepriceper': 'URL_FOR_LANDSCAPE',
                        '**liverpoollvp**-thepriceper': 'URL_FOR_LIVERPOOL_LVP',
                        '**colourplus**-thepriceper': 'URL_FOR_COLOUR_PLUS',
                        '**aberdeen**-thepriceper': 'URL_FOR_ABERDEEN',
                        '**saipan**-thepriceper': 'URL_FOR_SAIPAN',
                        ...
                        '**madinahmosque**-thepriceper': 'URL_FOR_MADINAH_MOSQUE',
