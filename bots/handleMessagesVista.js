    ...
    try {
     ...
     const cleanMessage2 = Object.fromEntries(
        ...
        const fcmMessage = {
            ...
            topic: '003' // Specify the topic here
        };
        ...
        console.log(`FCM notification sent to topic '003'`);
  ...
  async function scheduleReminderMessage(eventSummary, startDateTime, chatId) {
    ...
    console.log('Scheduled time in seconds:', scheduledTimeSeconds);
      ...
      const scheduledMessage = {
        batchQuantity: 1,
        chatIds: [chatId],
        companyId: "003", // Assuming this is the correct company ID
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:8443/api/schedule-message/003`, scheduledMessage);
...
async function handleNewMessagesVista(client, msg, botName, phoneIndex) {
...
async function checkingStatus(threadId, runId) {
    ...
    if(status == 'completed') {
        try{
            ...
            console.log("error from handleNewMessagesVista: "+error)
            throw error;
        }
    }
...
module.exports = { handleNewMessagesVista };