// handleMessagesTemplateWweb2.js
...
async function handleNewMessagesTemplateWweb2(client, msg) {
    console.log('DEBUG: handleNewMessagesTemplateWweb2 function called', msg);
...
async function checkingStatus(threadId, runId) {
    ...
    if(status == 'completed') {
        ...
        try{
            ...
            console.log("error from handleNewMessageswweb2: "+error)
        }
...
module.exports = { handleNewMessagesTemplateWweb2 };