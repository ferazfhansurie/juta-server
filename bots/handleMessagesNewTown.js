            ...
            switch (currentStep) {
                case steps.START:
                    ...
                    for (let i = 0; i < parts.length; i++) {
                        ...
                        if(part.includes('We have the following LPG Gas Cylinders:')){
                            const imagePath = 'https://i.postimg.cc/qRZNrbWQ/1574391439-14kg.png'; // Update this URL to your image URL
