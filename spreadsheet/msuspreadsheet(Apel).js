...
class msuSpreadsheetApel {
  constructor(botMap) {
    this.botName = '065';
    this.spreadsheetId = '1khSQlU0R9sB2y0u6F7-HtCSBE8d8Ax3dSn8_ykl5kns';
    this.sheetName = 'APEL Leads 5 July - 4 Sept 2024';
  ...
  async markRowAsSent(rowIndex) {
    try {
      await this.sheets.spreadsheets.values.update({
        spreadsheetId: this.spreadsheetId,
        range: `${this.sheetName}!L${rowIndex}`, // Column Q is for "WA Sent"
...
module.exports = msuSpreadsheetApel;